...
$select = "SELECT * FROM loans WHERE loanstatus = 'Active' AND dispatch_status = 'Dispatched'";
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="dispatched.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Dispatched Loans</a>
        ...
        <div class="content" style="width: 100%;">
            ...
            <!-- <div class="navbar-nav align-items-center ms-auto"> -->
                ...
                <h2>Dispatched Loans</h2>
    <table border="1" class="table" style="padding: 20px; margin-top: 20px;"id="dispatched">
        <thead>
            <tr>
                <th>Loan ID</th>
                <th>F_idNumber</th>
    ...
    <button type="button" class="btn btn-primary" onclick="printCard('dispatched')">Print Report</button>
