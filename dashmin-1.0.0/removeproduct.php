    ...
    <script>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'deleteproduct.php', // Adjust the file name accordingly
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="removeproduct.php" class="dropdown-item active">Remove product</a>
                        </div>
                    </div>
            ...
            <h2> Products </h2>
                ...
                if (mysqli_num_rows($selectresult) > 0) {
                    while ($row = mysqli_fetch_assoc($selectresult)) {
                        ...
                        echo "<td><button class='deleteBtn' onclick='deleteProduct(\"" . $row['product_id'] . "\")'>Delete Product</button></td>";
