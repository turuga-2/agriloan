    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="deniedloans.php" class="dropdown-item active">Denied Loans</a>
        ...
        <div class="content">
            ...
            <div class="align-items-center ms-auto">
                            ...
                            <h2>Denied Loans</h2>
                            <table id="deniedloans" class="table">
                                <thead>
                                    <tr>
                                        <th>Loan ID</th>
                                        <th>ID Number</th>
                                ...
                                <tbody>
                                    <!-- PHP code to fetch data from the farmers table in the database -->
                                        ...
                                        $sql = "SELECT * FROM loans WHERE loanstatus='Denied'";
                                        ...
                                        ?>
                                         <tfoot>
                                            <tr>
                                                ...
                                                <td>Total Loan Amount:<br> <?php echo $totalLoanTotal; ?></td>
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="printCard('deniedloans')">Print Report</button>
